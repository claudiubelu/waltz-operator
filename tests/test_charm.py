        ...
        expected_plan = {
            "services": {
                "waltz": {
                    ...
                    "user": "waltz",
                    "environment": {
                        "DB_HOST": self.harness.charm.config["waltz-db-host"],
                        "DB_PORT": self.harness.charm.config["waltz-db-port"],
                        "DB_NAME": self.harness.charm.config["waltz-db-name"],
                        "DB_USER": self.harness.charm.config["waltz-db-username"],
                        "DB_PASSWORD": self.harness.charm.config["waltz-db-password"],
                        "DB_SCHEME": "waltz",
